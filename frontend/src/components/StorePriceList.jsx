...
// Map store name keywords → logo file in /public/logos/
const STORE_LOGOS = {
...
// Accent colours for the logo container background when logo fails to load
const STORE_COLORS = {
...
function getStoreMeta(name) {
  const key = Object.keys(STORE_LOGOS).find(k => name.toLowerCase().includes(k));
  return {
