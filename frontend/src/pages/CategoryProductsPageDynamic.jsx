...
import { formatCountLabel, getCategoryLabel, normalizeProductsForGrid } from '../lib/productAdapters';

export default function CategoryProductsPageDynamic() {
  ...
  const displayTitle = getCategoryLabel(categoryName);
            ...
            <div className="flex-1">
              {error ? (
                ...
                <div className="rounded-2xl border border-slate-200 bg-white px-6 py-12 text-center text-slate-500">
                  Loading {displayTitle.toLowerCase()} from the database...
                </div>
              ) : (
